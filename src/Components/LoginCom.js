...
class LoginCom extends Component {
  ...
  // getUsers() {
  //   console.log("in getuserfunction")
  ...
  handleLogin(e) {
    ...
    //this.props.router.navigate("/sidebar");
    ...
    if (this.checkBtn.context._errors.length === 0) {
      AuthService.login(this.state.username, this.state.password).then(
        () => {
          //this.props.router.navigate('/mainpage');
          this.props.router.navigate("/TimeSheet");
    ...
    return (
      ...
      <div className="col-md-12">
        <div className="card card-container">
          ...
          { <img
            src= "fotor_2023-5-16_14_6_13.png" height={30} 
            alt="profile-img"
          ...
          >
            ...
            />
          <h2 className="Welcome">Welcome To Evision</h2>
